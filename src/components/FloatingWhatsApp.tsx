...
const FloatingWhatsApp = () => {
  ...
  const message =
    lang === "pt"
      ? "Ol%C3%A1%2C%20vim%20do%20site%20e%20quero%20saber%20mais%20da%20AD%20Company."
      : "Hola%2C%20vengo%20del%20sitio%20y%20quiero%20saber%20m%C3%A1s%20de%20AD%20Company.";

  return (
    <a
      href={`https://wa.me/5548994952650?text=${message}`}
      target="_blank"
